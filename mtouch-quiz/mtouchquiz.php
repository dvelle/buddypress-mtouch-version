...
function mtq_activate() {
	...
	if($database_version = $installed_db) {
		...
		$sql = "CREATE TABLE {$wpdb->prefix}mtouchquiz_answer (
				...
				CREATE TABLE {$wpdb->prefix}things_students (
  					ID int(11) unsigned NOT NULL AUTO_INCREMENT,
  					student_id int(11) unsigned NULL,
  					progress_record varchar(500) NOT NULL default 0,
  					rank int(4) NOT NULL default 0,
  					title varchar(40) NOT NULL default 'Amateur',
				...
				CREATE TABLE {$wpdb->prefix}mtouchquiz_quiz (
					...
					badge_url varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
					assigned_module int(11) unsigned NOT NULL,
